  ...
  return (
    <div className="min-h-screen bg-[#030305] text-white flex flex-col relative overflow-hidden bg-grid-pattern font-sans">
      ...
      <header className="border-b border-white/5 bg-[#030305]/60 backdrop-blur-md sticky top-0 z-30 pt-[calc(env(safe-area-inset-top,0px)+12px)]">
        <div className="max-w-7xl mx-auto px-3 sm:px-6 h-16 flex items-center justify-between gap-1.5">
          <div className="flex items-center gap-1.5 sm:gap-3 flex-shrink-0">
            <h1 className="font-black text-white tracking-tight font-outfit text-xs sm:text-sm uppercase flex items-center gap-1.5">
              <Database className="w-3.5 h-3.5 text-violet-400" />
              <span>GlowWave Admin</span>
              <span className="hidden xs:inline text-[9px] text-zinc-500 font-extrabold">BI PLATFORM</span>
            </h1>
          </div>
          ...
          <div className="flex items-center gap-1.5 sm:gap-3 flex-shrink-0">
            <button 
              ...
              className="px-2 py-1.5 sm:px-3.5 sm:py-2 bg-emerald-500/10 hover:bg-emerald-500/20 border border-emerald-500/20 text-emerald-400 rounded-xl text-[10px] sm:text-xs font-bold transition-all flex items-center gap-1 cursor-pointer shadow-sm relative"
            >
            ...
            <button 
              ...
              className="p-1.5 sm:p-2 bg-white/5 hover:bg-white/10 border border-white/10 text-zinc-400 hover:text-white rounded-xl text-[10px] sm:text-xs font-bold transition-all flex items-center gap-1 cursor-pointer shadow-sm"
              title="로그아웃"
            >
